    ...
    UpdateStudent() {
        ...
        try{
          ...
          while(rs.next())
          {
              ...
              labelaadhar.setText(rs.getString("adhaar"));
...
try
{
   String query = "UPDATE student1 SET address='" + address + "', phone='"+phone + "', email='" + email + "', course='" + course + "',branch='" + branch +"' WHERE rollno='" + rollno + "'";
